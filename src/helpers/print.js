    ...
    content: [
      {
        columns: [
          ...
          },
          {
            ...
            stack: [
              {
                text: "Calcul des stationnements et équipements",
                style: "header",
              },
              {
      ...
      {
        text: `Date: ${new Date().toLocaleString("fr-CH")} / dossier SATAC: ${
          project.satac
        } / Commune: ${
          project.commune.comnom
        } / Biens-fonds: ${project.parcels.join(", ")} / Type de localisation ${
          project.locationType.name
        } ${project.eco === true ? "/ Projet de quartier durable" : ""}`,
        style: "body",
            ...
            ...project
              ...
              .map((o) => [
                ...
                [
                  // Affectation
                  {
                    rowSpan: o.getOutputs(["car", "special"]).length + 2,
                    text: o.name,
                    style: "tableBody",
                    alignment: "left",
                  },
                  ...
                  // Facteur(s) de réduction
                  {
                    rowSpan: o.getOutputs(["car", "special"]).length + 2,
                    ul: o
                      .getVariables(["special reduction"])
                      .filter((e) => e.value > 0)
                  ...
                  // Besoin brut
                  {
                    text: o.getRawOutputs(["car"])[0].value.toFixed(1),
                    style: "tableBody",
                    alignment: "right",
                    noWrap: true,
                  },
                  ...
                  // Besoin net
                  {
                    text: o.getNetOutputs(["car"])[0].value.toFixed(1),
                    style: "tableBody",
                    alignment: "right",
                    noWrap: true,
                  },
                  ...
                  // Besoin net réduit
                  {
                    text: o.getReducedOutputs(["car"])[0].value.toFixed(1),
                    style: "tableBody",
                    alignment: "right",
                    noWrap: true,
                  },
                ...
                ...o.outputs
                  ...
                  .map((el, i) => [
                    ...
                    // Besoin brut
                    {
                      text: o.getRawOutputs(["car"])[i + 1].value.toFixed(1),
                      style: "tableBody",
                      alignment: "right",
                      noWrap: true,
                    },
                    ...
                    // Besoin net
                    {
                      text: o.getNetOutputs(["car"])[i + 1].value.toFixed(1),
                      style: "tableBody",
                      alignment: "right",
                      noWrap: true,
                    },
                ...
                [
                  ...
                  {
                    text: o.getTotalOutput(["car"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
                  ...
                  {
                    text: o.getTotalNetOutput(["car"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
                  ...
                  {
                    text: o.getTotalReducedOutput(["car"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
                ...
                [
                  ...
                  // Places à réaliser (sous-total)
                  {
                    text: o.getTotalReducedOutput(["special"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
            ...
            [
              ...
              },
              {
                text: Math.ceil(
                  project
                    .getAffectations()
                    .map((x) => x.getTotalReducedOutput(["car", "special"]))
                    .reduce((acc, obj) => {
                      return acc + obj;
                    }, 0)
                ),
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              {
                text: project.getAffectationNames("Logement").join("; "),
                style: "tableBody",
                alignment: "left",
              },
              {
                text: "Niveau D (bornes)",
                style: "tableBody",
                alignment: "left",
              },
              {
                text: project.getStations("Logement"),
                style: "tableBody",
                alignment: "right",
              },
            ],
            [
              ...
              {
                text: project.getAffectationNames("Activité").join("; "),
                style: "tableBody",
                alignment: "left",
              },
              {
              ...
              {
                text: project.getStations("Activité"),
                style: "tableBody",
                alignment: "right",
              },
            ],
            [
              {
                text: "Logements et activités",
                style: "tableBody",
                alignment: "left",
              },
              {
                text: "Cf. affectations ci-dessus",
                style: "tableBody",
                alignment: "left",
              },
              ...
              {
                text:
                  Math.ceil(project.getReducedNeeds(["car", "special"])) -
                  project.getStations("Logement") -
                  project.getStations("Activité") -
                  project.getStations("Pas concerné"),
                style: "tableBody",
                alignment: "right",
              },
            ],
      ...
      {
        text: `Affectation(s) non-concernée(s): ${project
          .getAffectationNames("Pas concerné")
          .join("; ")}`,
        style: "body",
        margin: [0, 5, 0, 2], // [left, top, right, bottom]
        render:
          project.type.equipement &
          (project.getAffectationNames("Pas concerné").length > 0),
      },
            ...
            ...project
              ...
              .map((o) => [
                ...
                [
                  // Affectation
                  {
                    rowSpan: o.getOutputs(["motorcycle"]).length + 1,
                    text: o.name,
                    style: "tableBody",
                    alignment: "left",
                  },
                  ...
                  // Catégorie
                  {
                    text: o.getOutputs(["motorcycle"])[0].name,
                    style: "tableBody",
                    alignment: "left",
                  },
                  ...
                  {
                    text: o
                      .getReducedOutputs(["motorcycle"])[0]
                      .value.toFixed(1),
                    style: "tableBody",
                    alignment: "right",
                    noWrap: true,
                ...
                [
                  ...
                  // Places à réaliser (sous-total)
                  {
                    text: o.getTotalReducedOutput(["motorcycle"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
            ...
            [
              ...
              { text: "", style: "tableHeader", alignment: "left" },
              {
                text: Math.ceil(
                  project
                    .getAffectations()
                    .map((x) => x.getTotalReducedOutput(["motorcycle"]))
                    .reduce((acc, obj) => {
                      return acc + obj;
                    }, 0)
                ),
            ...
            ...project
              ...
              .map((o) => [
                ...
                [
                  // Affectation
                  {
                    rowSpan: o.getOutputs(["bicycle"]).length + 1,
                    text: o.name,
                    style: "tableBody",
                    alignment: "left",
                  },
                  ...
                  // Catégorie
                  {
                    text: o.getOutputs(["bicycle"])[0].name,
                    style: "tableBody",
                    alignment: "left",
                  },
                  ...
                  // Places à réaliser
                  {
                    text: o.getReducedOutputs(["bicycle"])[0].value.toFixed(1),
                    style: "tableBody",
                    alignment: "right",
                    noWrap: true,
                  },
                ...
                [
                  ...
                  // Places à réaliser (sous-total)
                  {
                    text: o.getTotalReducedOutput(["bicycle"]).toFixed(1),
                    style: "tableBody",
                    bold: true,
                    alignment: "right",
                    noWrap: true,
            ...
            [
              ...
              { text: "", style: "tableHeader", alignment: "left" },
              {
                text: Math.ceil(
                  project
                    .getAffectations()
                    .map((e) => e.getTotalReducedOutput(["bicycle"]))
                    .reduce((acc, obj) => {
                      return acc + obj;
                    }, 0)
                ),
