  ...
  */
  ...
  new Affectation({
    ...
    variables: [
      ...
      { id: "n_car_cmp_prk", name: "# places pour véhicules d’entreprise", description: "", type: "measurement", unit: "", min: 0.0, max: Infinity, value: 0.0, hint: "Facultatif, 0 par défaut" },
      { id: "n_car_shr_prk", name: "# places pour autopartage", description: "", type: "measurement", unit: "", min: 0.0, max: Infinity, value: 0.0, hint: "Facultatif, à justifier si des places sont demandées, 0 par défaut " },
      { id: "zone_rdn", name: "zone", description: "", type: "reduction", unit: "%", min: 0.0, max: 100.0, value: 0.0, hint: "" },
    ...
    outputs: [
      ...
      { group: "bicycle", icon: "directions_bike", name: "# places vélos visiteurs", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.05 * x.get('n_staff')) : Math.ceil(0.001 * x.get('floor_area'))) },
  ...
  new Affectation({
    ...
    outputs: [
      ...
      { group: "car", icon: "directions_car", name: "# places pour véhicules d’entreprise", formula: ((x) => x.get('n_car_cmp_prk') * 1.0) },
      { group: "car", icon: "directions_car", name: "# places pour autopartage", formula: ((x) => x.get('n_car_shr_prk') * 1.0) },
      { group: "motorcycle", icon: "motorcycle", name: "# places motos habitants/visiteurs", formula: ((x, f = 100.0, r = 0.0) => 0.15 * (0.02 * x.get('floor_area') + 0.01 * x.get('floor_area')) * (f / 100) * (1 - r / 100)) },
      ...
      { group: "bicycle", icon: "directions_bike", name: "# places vélos visiteurs", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.3 * x.get('n_staff')) : Math.ceil(0.015 * x.get('floor_area'))) },
  ...
  new Affectation({
    ...
    outputs: [
      ...
      { group: "bicycle", icon: "directions_bike", name: "# places vélos personnel", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.2 * x.get('n_staff')) : Math.ceil(0.01 * x.get('floor_area'))) },
      { group: "bicycle", icon: "directions_bike", name: "# places vélos visiteurs", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.05 * x.get('n_staff')) : Math.ceil(0.0025 * x.get('floor_area'))) },
  ...
  new Affectation({
    ...
    outputs: [
      ...
      { group: "bicycle", icon: "directions_bike", name: "# places vélos personnel", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.2 * x.get('n_staff')) : Math.ceil(0.01 * x.get('floor_area'))) },
      { group: "bicycle", icon: "directions_bike", name: "# places vélos visiteurs", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.25 * x.get('n_staff')) : Math.ceil(0.015 * x.get('floor_area'))) },
  ...
  new Affectation({
    ...
    outputs: [
      ...
      { group: "bicycle", icon: "directions_bike", name: "# places vélos personnel", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(0.2 * x.get('n_staff')) : Math.ceil(0.01 * x.get('floor_area'))) },
      { group: "bicycle", icon: "directions_bike", name: "# places vélos visiteurs", formula: ((x) => x.get('n_staff') > 0 ? Math.ceil(1.0 * x.get('n_staff')) : Math.ceil(0.015 * x.get('floor_area'))) },
  ...
  new Affectation({
    ...
    outputs: [
      ...
      { group: "car", icon: "directions_car", name: "# places voitures visiteurs", formula: ((x, f = 100.0, r = 0.0) => x.get('n_car_vis_prk') * (f / 100) * (1 - r / 100)) },
      { group: "car", icon: "directions_car", name: "# places pour autopartage", formula: ((x) => x.get('n_car_shr_prk') * 1.0) },
      { group: "motorcycle", icon: "motorcycle", name: "# places motos personnel/clients", formula: ((x, f = 100.0, r = 0.0) => 0.15 * x.get('n_car_emp_prk') * (f / 100) * (1 - r / 100)) },
