  ...
  <q-layout view="hHh lpR fFf" class="shadow-2 rounded-borders">
    <q-header>
      ...
      <q-banner inline-actions class="bg-yellow text-black text-center">
        Les exigences en lien avec les équipements électriques mentionnés entrent en vigueur au <b>1er juillet 2024</b> (date de dépôt de la demande de permis de construire auprès de l'autorité communale).
