...
function add2(coordinate, delta) {
...
function addProjection(projection) {
  add3(projection.getCode(), projection);
...
function get3(projectionLike) {
  return typeof projectionLike === "string" ? get2(
    /** @type {string} */
    projectionLike
  ) : (
    /** @type {Projection} */
...
//# sourceMappingURL=chunk-GIURMW3G.js.map
