...
import {
  ...
  getKey,
  getKeyZXY
} from "./chunk-QMHSUCND.js";
import {
  Image_default
} from "./chunk-VI4726CB.js";
import {
  Source_default
} from "./chunk-W26NB3OA.js";
import {
...
} from "./chunk-DWOUCNIR.js";
import {
  Feature_default
} from "./chunk-SMBBTBM4.js";
import {
  BaseTile_default,
  ...
  Tile_default as Tile_default4,
  canvasPool as canvasPool2
} from "./chunk-AVMTKZSR.js";
import {
  ImageTile_default,
  Tile_default,
  Tile_default2
} from "./chunk-FTNAS3YZ.js";
import {
  TileRange_default
...
import {
  ...
  registerFont,
  shared
} from "./chunk-4IP4HMJU.js";
import {
  Collection_default
} from "./chunk-WW75XS5D.js";
import {
...
import {
  ...
  snap
} from "./chunk-BJ737D57.js";
import "./chunk-X65FIXFX.js";
import {
  Point_default,
...
import {
  ...
  listen,
  unlistenByKey
} from "./chunk-L32XKJJF.js";
import {
  ascending,
  equals,
  extend,
  reverseSubArray
} from "./chunk-4JOO455T.js";
import {
  clear,
  isEmpty
  ...
  createHitDetectionCanvas_(renderOptions) {
    if (this.fill_) {
      ...
      if (color2 === null) {
        ...
        opacity = color2.length === 4 ? color2[3] : 1;
      }
      if (opacity === 0) {
        const context2 = createCanvasContext2D(
          renderOptions.size,
...
var Style = class {
  ...
  clone() {
    ...
    if (geometry2 && typeof geometry2 === "object") {
      geometry2 = /** @type {import("../geom/Geometry.js").default} */
      geometry2.clone();
    }
    return new Style({
      geometry: geometry2,
  ...
  setGeometry(geometry2) {
    if (typeof geometry2 === "function") {
      this.geometryFunction_ = geometry2;
    } else if (typeof geometry2 === "string") {
      this.geometryFunction_ = function(feature) {
        return (
          /** @type {import("../geom/Geometry.js").default} */
          feature.get(geometry2)
        );
      };
    } else if (!geometry2) {
      this.geometryFunction_ = defaultGeometryFunction;
    } else if (geometry2 !== void 0) {
...
var IconImage = class extends Target_default {
   ...
   */
  constructor(image, src, size, crossOrigin, imageState, color2) {
    super();
...
function get2(image, src, size, crossOrigin, imageState, color2) {
  let iconImage = shared.get(src, crossOrigin, color2);
  if (!iconImage) {
    iconImage = new IconImage(image, src, size, crossOrigin, imageState, color2);
    shared.set(src, crossOrigin, color2, iconImage);
  }
  return iconImage;
}
    ...
    if (textState.placement === "line" && (geometryType2 == "LineString" || geometryType2 == "MultiLineString" || geometryType2 == "Polygon" || geometryType2 == "MultiPolygon")) {
      ...
      switch (geometryType2) {
        ...
        case "MultiLineString":
          ...
          geometry2.getFlatMidpoints();
          stride = 2;
          break;
        case "Polygon":
          flatCoordinates = /** @type {import("../../geom/Polygon.js").default} */
          geometry2.getFlatInteriorPoint();
        ...
        case "MultiPolygon":
          const interiorPoints = (
            /** @type {import("../../geom/MultiPolygon.js").default} */
            geometry2.getFlatInteriorPoints()
          );
          flatCoordinates = [];
...
var Executor = class {
   ...
   */
  replayImageOrLabel_(context2, contextScale, imageOrLabel, dimensions, opacity, fillInstruction2, strokeInstruction2) {
   ...
   * @template T
   */
  execute_(context2, contextScale, transform, instructions, snapToPixel, featureCallback, hitExtent, declutterTree) {
    ...
    while (i < ii) {
      ...
      switch (type) {
        ...
        case Instruction_default.CIRCLE:
          ...
          context2.moveTo(x1 + r, y1);
          context2.arc(x1, y1, r, 0, 2 * Math.PI, true);
          ++i;
          break;
   ...
   * @param {import("rbush").default} [declutterTree] Declutter tree.
   */
  execute(context2, contextScale, transform, viewRotation, snapToPixel, declutterTree) {
   ...
   * @template T
   */
  executeHitDetection(context2, transform, viewRotation, featureCallback, hitExtent) {
    this.viewRotation_ = viewRotation;
...
var ExecutorGroup = class {
   ...
   * @param {import("rbush").default} [declutterTree] Declutter tree.
   */
  execute(context2, contextScale, transform, viewRotation, snapToPixel, builderTypes, declutterTree) {
    const zs = Object.keys(this.executorsByZIndex_).map(Number);
    zs.sort(ascending);
    if (this.maxExtent_) {
      context2.save();
      this.clip(context2, transform);
    }
...
var CanvasImmediateRenderer = class extends VectorContext_default {
   ...
   */
  constructor(context2, pixelRatio, extent, transform, viewRotation, squaredTolerance, userTransform) {
    super();
  ...
  drawText_(flatCoordinates, offset, end, stride) {
    ...
    for (; offset < end; offset += stride) {
      ...
      if (rotation !== 0 || this.textScale_[0] != 1 || this.textScale_[1] != 1) {
        context2.translate(x - this.textOffsetX_, y - this.textOffsetY_);
        ...
        if (this.textStrokeState_) {
          context2.strokeText(this.text_, x, y);
        }
        if (this.textFillState_) {
          context2.fillText(this.text_, x, y);
        }
      }
    }
  }
  ...
  moveToLineTo_(flatCoordinates, offset, end, stride, close) {
    ...
    for (let i = 2; i < length; i += 2) {
      context2.lineTo(pixelCoordinates[i], pixelCoordinates[i + 1]);
    }
    if (close) {
      context2.closePath();
    }
  ...
  drawCircle(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/Circle.js").default} */
      geometry2.simplifyTransformed(
  ...
  drawPoint(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/Point.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  drawMultiPoint(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/MultiPoint.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  drawLineString(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/LineString.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  drawMultiLineString(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/MultiLineString.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  drawPolygon(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/Polygon.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  drawMultiPolygon(geometry2) {
    if (this.squaredTolerance_) {
      geometry2 = /** @type {import("../../geom/MultiPolygon.js").default} */
      geometry2.simplifyTransformed(
        this.squaredTolerance_,
        this.userTransform_
      );
  ...
  for (let i = 1; i <= featureCount; ++i) {
    ...
    for (let j = 0, jj = styles.length; j < jj; ++j) {
      ...
      if (type === "GeometryCollection") {
        const geometries = (
          /** @type {import("../../geom/GeometryCollection.js").default} */
          geometry2.getGeometriesArrayRecursive()
        );
...
var VectorRenderTile = class extends Tile_default {
  ...
  getContext(layer) {
    ...
    if (!(key in this.context_)) {
      this.context_[key] = createCanvasContext2D(1, 1, canvasPool3);
    }
  ...
  release() {
    for (const key in this.context_) {
      ...
      canvasPool3.push(context2.canvas);
...
var RasterSource = class extends Image_default {
  /**
   * @param {Options} options Options.
   */
  constructor(options) {
...
function createLayer(layerOrSource) {
  ...
  if (layerOrSource instanceof Source_default) {
    ...
    } else if (layerOrSource instanceof Image_default) {
...
Scope.prototype.get = function get3(name) {
...
Formatted.prototype.toString = function toString4() {
  if (this.sections.length === 0) {
    return "";
  }
...
ResolvedImage.prototype.toString = function toString5() {
  return this.name;
};
...
FormatExpression.prototype.evaluate = function evaluate3(ctx) {
  var evaluateSection = function(section) {
    ...
    return new FormattedSection(toString6(evaluatedContent), null, section.scale ? section.scale.evaluate(ctx) : null, section.font ? section.font.evaluate(ctx).join(",") : null, section.textColor ? section.textColor.evaluate(ctx) : null);
  };
...
Coercion.prototype.evaluate = function evaluate5(ctx) {
  if (this.type.kind === "boolean") {
    ...
    return Formatted$1.fromString(toString6(this.args[0].evaluate(ctx)));
  } else if (this.type.kind === "resolvedImage") {
    return ResolvedImage$1.fromString(toString6(this.args[0].evaluate(ctx)));
  } else {
    return toString6(this.args[0].evaluate(ctx));
  }
};
...
CompoundExpression$1.register(expressions, {
  ...
  "get": {
    ...
    overloads: [
      [
        ...
        function(ctx, ref) {
          var key = ref[0];
          return get4(key.evaluate(ctx), ctx.properties());
        }
      ],
      [
        [
        ...
        function(ctx, ref) {
          var key = ref[0];
          var obj = ref[1];
          return get4(key.evaluate(ctx), obj.evaluate(ctx));
        }
      ]
    ]
  },
  "feature-state": [
    ...
    function(ctx, ref) {
      var key = ref[0];
      return get4(key.evaluate(ctx), ctx.featureState || {});
    }
  ],
  "properties": [
    ObjectType,
  ...
  "concat": [
    ...
    function(ctx, args) {
      return args.map(function(arg) {
        return toString6(arg.evaluate(ctx));
      }).join("");
    }
  ],
  "resolved-locale": [
...
function applyStyle(layer, glStyle, sourceOrLayersOrOptions, optionsOrPath, resolutions) {
  ...
  return new Promise(function(resolve, reject) {
    getGlStyle(glStyle, options).then(function(glStyle2) {
      ...
      if (!(layer instanceof Vector_default2 || layer instanceof VectorTile_default)) {
